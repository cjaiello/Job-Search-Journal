package jobsearchjournal.general;
...
public class PhoneCallCounter {
    ...
    public static Integer getNumberOfPhoneCalls (Activity activity, String phoneNumber) {
        ...
        // This is our query
        Cursor cursor = activity.getContentResolver().query(Call//Log.Calls.CONTENT_URI, null, Call//Log.Calls.NUMBER + " = ? ", selectionArgs, null);
